...
describe('Service Tests', () => {
  describe('Galaxy Service', () => {
    let injector: TestBed;
    let service: GalaxyService;
    let httpMock: HttpTestingController;
    let elemDefault: IGalaxy;
    let expectedResult;
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(GalaxyService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Galaxy(0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Galaxy', async () => {
      ...
      it('should update a Galaxy', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            type: 'BBBBBB'
